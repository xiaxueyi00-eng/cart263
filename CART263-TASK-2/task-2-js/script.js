...
function setup() {
    ...
    console.log("2) first paragraph element:", firstPTag);
    ...
    console.log("3) all .inner-container elements:", allInnerContainers);

    /***OUTPUT:
     * allInnerContainers -> NodeList of ALL elements with class "inner-container"
     * example: NodeList(4) [div.inner-container, div.inner-container, ...]
     */
